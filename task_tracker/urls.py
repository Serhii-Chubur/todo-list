...
from task_tracker.views import (TagListView, IndexView, TaskCreateView,
                                TagCreateView, TagUpdateView, TagDeleteView,
                                TaskUpdateView, TaskDeleteView, TaskCompletedView,
                                TaskUndoView)
...
urlpatterns = [
    ...
    path('task-complete/<int:pk>/', TaskCompletedView.as_view(), name='task-complete'),
    path('task-undo/<int:pk>/', TaskUndoView.as_view(), name='task-undo'),
